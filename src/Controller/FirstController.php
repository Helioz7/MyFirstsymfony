...
<nav><a href='./'>Accueil</a> | <a href='/json' target='_blank'>JSON</a> | <a href='./contact'>Contact</a></nav></body></html>");
    }

    public function form(): Response
    {
        return new Response("<html><body><h1>Contact</h1><nav><a href='./'>Accueil</a> | <a href='/json' target='_blank'>JSON</a>
